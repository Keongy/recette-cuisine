...
function CreateIngredientForm({ onSubmit }) {
    ...
    return <form className="d-flex align-items-start" onSubmit={handleSubmit}>
        <Field placholder="Nom de l'ingrédient" name="title" className="mr-2" error={errorFor('title')} />
        <Field placholder="Unité de mesure" name="unit" className="mr-2" error={errorFor('unit')} />
